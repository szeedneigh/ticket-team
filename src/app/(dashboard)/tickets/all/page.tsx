/**
 * All Tickets Page (staff+)
 *
 * Lists all tickets without default time filter restrictions.
 * Lives under /tickets/all so staff can access it (not under /admin/*).
 */
