          ...
          {messages.length === 0 && !isStreaming ? (
            ...
            <Virtuoso
              ...
              onScroll={(state) => {
                ...
                const isAtBottom = state.scrollTop >= (state.scrollHeight - state.viewportHeight - 10);
                const isScrollingDown = state.scrollDirection === 'down';
