    ...
    >
      ...
      <motion.div className="space-y-4" variants={itemVariants}>
        <div className="flex items-center gap-3">
          <h2 className="text-lg font-semibold">Priority Performance</h2>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-base font-semibold">{priority.count.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground">Avg Resolution</p>
                    <p className="text-base font-semibold">{priority.avgResolutionTime}</p>
                  </div>
                </div>
